...
public class ForecastAdapter extends CursorAdapter {
    ...
    public void setmUseTodayLayout(boolean isOnePane) {
        mUseTodayLayout = isOnePane;
    }
...
//    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        //Assign images based on the position in the listView. Today forecast gets colored icon whereas
        //rest of the forecast gets black and white icons
        int iconId = -1;
